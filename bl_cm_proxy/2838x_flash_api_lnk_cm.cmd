MEMORY
{
   ...
   CMBANK0_APPRESETISR  : origin = 0x00204000, length = 0x00000008/* App Flash Entry Point */
   CMBANK0_SECTOR1_2_3_4  : origin = 0x00204008, length = 0x0001BFF8
   ...
   CMBANK0_SECTOR7_8_9  : origin = 0x00240000, length = 0x00030000
   ...
   CMTOCPU1MSGRAM0_E_1  : origin = 0x20082000, length = 0x00001000
...
SECTIONS
{
   .resetisr        : > CMBANK0_RESETISR, ALIGN(64)
   .vftable         : > CMBANK0_SECTOR0, ALIGN(64)   /* Application placed vector table in Flash*/
   .vtable          : > S0RAM             /* Application placed vector table in RAM*/
   .text            : > CMBANK0_SECTOR0, ALIGN(64)
   .cinit           : > CMBANK0_SECTOR0, ALIGN(64)
   .pinit           : > CMBANK0_SECTOR0, ALIGN(64)
   .switch          : > CMBANK0_SECTOR0, ALIGN(64)
   .sysmem          : > S2RAM

   .stack           : > C1RAM
   .ebss            : > C1RAM
   .econst          : > CMBANK0_SECTOR0, ALIGN(64)
   .esysmem         : > C1RAM
   .data            : > S3RAM
   .bss             : > S3RAM
   .const           : > CMBANK0_SECTOR0, ALIGN(64)

    MSGRAM_CM_TO_CPU1 : > CMTOCPU1MSGRAM0_E_1, type=NOINIT
    ...
    DataBufferSection : > S3RAM, ALIGN(64)
